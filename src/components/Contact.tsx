                    ...
                    >
                        ...
                        <div className="space-y-8 font-sans">
                            <a href="mailto:mohammedriyaz8135@gmail.com" className="flex items-center gap-6 group">
                                <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center border border-white/5 group-hover:border-primary/50 group-hover:bg-primary/5 transition-all shrink-0">
                                    <Mail className="w-6 h-6 text-primary" />
                                </div>
                                <div className="overflow-hidden">
                                    <p className="text-white/40 text-[10px] uppercase tracking-widest mb-1">Email Me</p>
                                    <p className="text-lg md:text-xl font-bold break-all">mohammedriyaz8135@gmail.com</p>
                                </div>
                            </a>
                            ...
                            <a href="tel:+919948135827" className="flex items-center gap-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg md:text-xl font-bold">+91 9948135827</p>
                                </div>
                            </a>
                            ...
                            <div className="flex items-center gap-6 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg md:text-xl font-bold">Hyderabad, TS, India</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                                ...
                                <>
                                    <div className="grid grid-cols-1 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input required name="name" type="text" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all font-sans text-sm md:text-base" placeholder="Enter your full name" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] uppercase font-black text-white/40 tracking-widest">Email Address</label>
                                            <input required name="email" type="email" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all font-sans text-sm md:text-base" placeholder="Enter your email address" />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] uppercase font-black text-white/40 tracking-widest">Message</label>
                                        <textarea required name="message" rows={5} className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all resize-none font-sans text-sm md:text-base" placeholder="Tell me about your project..." />
                                    </div>
                                    <button
                                        disabled={formState === "submitting"}
                                        className="w-full btn-primary flex items-center justify-center gap-3 disabled:opacity-50 text-sm md:text-base py-4"
                                    >
